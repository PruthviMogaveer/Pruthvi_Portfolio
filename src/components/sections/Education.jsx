      ...
      <div className="relative lg:self-center flex space-x-40 max-md:space-x-20 max-md:self-center max-sm:space-x-12 self-start my-6">
        ...
        <div>
          {educations.map((education) => (
            <div
              key={education.year}
              className="max-sm:w-[17rem] p-5 b rounded-md shadow-educationbox my-12 before:absolute before:rounded-full before:-left-1 before:border-[5px] before:border-secondary dark:before:border-lightwhite "
            >
