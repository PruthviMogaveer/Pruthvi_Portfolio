...
const DarkModeToggle = () => {
  ...
  return (
    <label className=" relative inline-flex cursor-pointer select-none items-center justify-center rounded-md p-1">
      <input
        type="checkbox"
        id="darkmode"
      ...
      {!darkMode ? (
        <span
          className={`flex items-center  rounded py-2 px-[5px] text-sm font-medium ${
            darkMode
              ? "dark:text-black dark:bg-lightwhite"
              : "text-primary bg-lightwhite"
          }`}
        >
          <svg
            width="16"
        ...
        <span
          className={`flex items-center  rounded py-2 px-[5px] text-sm font-medium ${
            !darkMode
              ? "text-black bg-lightwhite"
              : "dark:text-primary dark:bg-lightwhite"
          }`}
        >
          <svg
            width="16"
